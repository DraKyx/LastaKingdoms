...
public enum CustomArmorMaterials implements IArmorMaterial {
    ...
    VLADINITE_ARMOR(Main.MODID + ":vladinite", 120, new int[]{7,8, 11, 7}, 23, SoundEvents.ARMOR_EQUIP_DIAMOND, 3.3F, 0.2F, () -> {
        return Ingredient.of(ModItems.VLADINITE_INGOT.get());
    });
